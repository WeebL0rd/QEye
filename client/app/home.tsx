...
import QuestionnaireService, { Questionnaire } from '../src/services/questionnaireService';
...
export default function HomeScreen() {
    ...
    <View style={styles.card}>
      ...
      <View style={styles.cardActions}>
        <TouchableOpacity
          ...
          onPress={() => router.push({ pathname: '/edit-questionnaire', params: { id: item.id } })}
        >
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        style={styles.fab}
        onPress={() => router.push('/create-questionnaire')}
      >
