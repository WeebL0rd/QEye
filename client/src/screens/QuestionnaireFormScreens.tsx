...
import QuestionnaireService, {
  Questionnaire, CreateQuestionnaireDTO, UpdateQuestionnaireDTO,
} from '../services/questionnaireService';
import type { HomeStackParamList } from '../navigation/HomeNavigator';

//CREATE
type CreateProps = {
  navigation: NativeStackNavigationProp<HomeStackParamList, 'CreateQuestionnaire'>;
};

export const CreateQuestionnaireScreen = ({ navigation }: CreateProps) => {
...
//EDIT
type EditProps = {
  navigation: NativeStackNavigationProp<HomeStackParamList, 'EditQuestionnaire'>;
  route: RouteProp<HomeStackParamList, 'EditQuestionnaire'>;
};

export const EditQuestionnaireScreen = ({ navigation, route }: EditProps) => {
  ...
  useEffect(() => {
    const load = async () => {
      try {
        const data: Questionnaire = await QuestionnaireService.getById(questionnaireId);
        setTitle(data.title);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await QuestionnaireService.update(questionnaireId, dto);
      navigation.goBack();
    } catch {
